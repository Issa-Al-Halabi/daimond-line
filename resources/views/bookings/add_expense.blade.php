            ...
            <div class="col-lg-12">
                <div class="card card-success">
                    <div class="card-header">
                        <h5 class="box-tittle">@lang('fleet.add_expense_trip'):</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('booking_expense') }}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" value="{{ $trip->id }}" class="form-control" name="trip_id">
                            {{ csrf_field() }}
                            ...
                            <table class="courselist table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="text" class="course_name form-control" placeholder="Enter Type "
                                                required name="type[]">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="1" class="form-control" placeholder="50"
                                                    required name="price[]">
