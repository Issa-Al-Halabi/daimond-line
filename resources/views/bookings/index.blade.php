                        ...
                        <table class="table table-responsive display" id="ajax_data_table"
                            ...
                            <thead class="thead-inverse">
                                <tr>
                                    ...
                                    <th style="width: 10% !important">@lang('fleet.from')</th>
                                    <th style="width: 10% !important">@lang('fleet.destination')</th>
                                    <th style="width: 10% !important">@lang('fleet.to')</th>
