        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header with-border">
                    <h3 class="card-title"> @lang('fleet.manage_trips') &nbsp;
                        <!--@can('Bookings add')-->
                        <!--    <a href="{{ route('bookings.create') }}" class="btn btn-success" title="@lang('fleet.new_booking')"><i-->
                        ...
                        <table class="table table-responsive display" id="ajax_data_table"
                            ...
                            <thead class="thead-inverse">
                                <tr>
                                    ...
                                    <!--</th>-->
                                    <th style="width: 10% !important">@lang('fleet.no')</th>
                                    <th style="width: 10% !important">@lang('fleet.customer')</th>
                                   <th style="width: 10% !important">@lang('fleet.options')</th>
                                    <th style="width: 10% !important">@lang('fleet.vehicle_type')</th>
                                    <th style="width: 10% !important">@lang('fleet.pickup_addr')</th>
                                    <th style="width: 10% !important">@lang('fleet.dest_addr')</th>
                                    <th style="width: 10% !important">@lang('fleet.date')</th>
                                    <th style="width: 10% !important">@lang('fleet.time')</th>
                                    <th style="width: 10% !important">@lang('fleet.km')</th>
                                    <th style="width: 10% !important">@lang('fleet.status')</th>
                                    <th style="width: 10% !important">@lang('fleet.cost')</th>
                                    <th style="width: 10% !important">@lang('fleet.action')</th>
                                    {{-- <th style="width: 10% !important">@lang('fleet.vehicle_model')</th> --}}
                                    {{-- <th style="width: 10% !important">@lang('fleet.title')</th> --}}
                                    {{-- <th style="width: 10% !important">@lang('fleet.direction')</th> --}}
                                    {{-- <th style="width: 10% !important">@lang('fleet.km')</th> --}}
                                    {{-- <th style="width: 10% !important">@lang('fleet.minutes')</th> --}}
                                    {{-- <th style="width: 10% !important">@lang('fleet.time')</th> --}}
                                    {{-- <th style="width: 10% !important">@lang('fleet.date')</th> --}}

                                    {{-- <th style="width: 10% !important">@lang('fleet.Tour')?</th> --}}
                                    {{-- <th style="width: 10% !important">@lang('fleet.pickup_addr')</th>
                    ...
                    <div class="fleet card-body">
                        ...
                        @if (Hyvikk::get('tax_charge') != 'null')
                            ...
                            @foreach ($taxes as $key => $val)
                                <input type="hidden" name="{{ 'tax_' . $i }}" value="{{ $val }}"
                                    class="{{ 'tax_' . $i }}">
                                @php($i++)
                            @endforeach
                        @endif
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        {!! Form::number('total_tax_charge', 0, [
                                            'class' => 'form-control
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          sum',
                                            'readonly',
                                            'id' => 'total_tax_charge',
        ...
        $(function() {
            ...
            var table = $('#ajax_data_table').DataTable({
               ...
               // }],
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin/booking_delay/incity-fetch') }}",
                    type: 'POST',
                    data: {}
                },
                columns: [
