            ...
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">@lang('fleet.coupons') &nbsp;
                        @can('Users add')
                            <a href="{{ route('coupons.create') }}" class="btn btn-success" title="@lang('fleet.addCoupon')"><i
                    ...
                    <table class="table" id="ajax_data_table">
                        <thead class="thead-inverse">
                            <tr>
                                ...
                                <th>@lang('fleet.code')</th>
                                <th>@lang('fleet.discount')</th>
                                <th>@lang('fleet.limit')</th>
                                <th>@lang('fleet.start_date')</th>
                                <th>@lang('fleet.expire_date')</th>
