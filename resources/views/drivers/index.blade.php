        ...
        <div class="col-md-12">
            ...
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title" style="color:#fbfbfb;">@lang('fleet.manage_drivers') &nbsp;
                        @can('Drivers add')
                            <a href="{{ route('drivers.create') }}" class="btn btn-success" title="@lang('fleet.addDriver')"> <i
