<div class="btn-group" style="background:#075296;">
    ...
    <div class="dropdown-menu custom" role="menu">
        ...
        @can('Drivers edit')
            <a class="dropdown-item" href="{{ url('admin/drivers/' . $row->id . '/edit') }}"> <span aria-hidden="true"
                    class="fa fa-edit" style="color: #075296;"></span> @lang('fleet.edit')</a>
        @endcan
        @can('Drivers edit')
            <a class="dropdown-item" href="{{ url('admin/drivers/' . $row->id) }}"> <span aria-hidden="true"
        ...
        @if ($row->is_active == 'active')
            <a class="dropdown-item" href="{{ url('admin/drivers/disable/' . $row->id) }}" class="mybtn"
                data-toggle="tooltip" title="@lang('fleet.disable_driver')"><span class="fa fa-times" aria-hidden="true"
                    style="color: #075296;;"></span> @lang('fleet.disable_driver')</a>
        @else
            <a class="dropdown-item" href="{{ url('admin/drivers/enable/' . $row->id) }}" class="mybtn"
                data-toggle="tooltip" title="@lang('fleet.enable_driver')"><span class="fa fa-check" aria-hidden="true"
                    style="color: ##075296;"></span> @lang('fleet.enable_driver')</a>
        @endif
    </div>
</div>
{!! Form::open([
