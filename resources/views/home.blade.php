...
<div class="row">
  ...
  <div class="col-12 col-sm-6 col-md-3">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">@lang('fleet.external_drivers')</span>
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            ...
            <div class="info-box mb-3 bg-warning">
              ...
              <div class="info-box-content">
                <span class="info-box-text">@lang('fleet.City_Trips')</span>
                <span class="info-box-number">{{$insidecity}}</span>
              </div>
            </div>
            @endcan
            ...
            <div class="info-box mb-3 bg-danger">
              <span class="info-box-icon"><i class="fa fa-address-book"></i></span>
              <div class="info-box-content">
                <span class="info-box-text">@lang('fleet.OutCity_Trips')</span>
                <span class="info-box-number">{{$outcity}}</span>
              </div>
            </div>
            @endcan
