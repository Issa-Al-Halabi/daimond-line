            ...
            <div class="card card-success">
                ...
                <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <select id="vehicle_id" name="vehicle_id" class="form-control vehicles" required
                                        ...
                                        @foreach ($vehicels as $vehicle)
                                            <option value="{{ $vehicle->id }}" data-mileage="{{ $vehicle->mileage }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <input required="required" name="mileage" type="number" id="mileage"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <input required="required" name="date" type="text" value="{{ date('Y-m-d') }}"
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    <div class="input-group">
                                        ...
                                        <input required="required" name="revenue" type="number" step="0.01"
                                            id="revenue" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    <div class="input-group">
                                        ...
                                        <input name="tax_percent" type="text" id="tax_percent" class="form-control"
                                            readonly value="{{ $tax_percent }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3" style=" margin-top: 5px;">
                            <div class="form-group">
                                {!! Form::label('tax_charge_rs', __('fleet.total') . ' ' . __('fleet.tax_charge'), [
                                ...
                                <div class="col-xs-6">
                                    <div class="input-group">
                                        ...
                                        <input required="required" name="tax_charge_rs" type="text" id="tax_charge_rs"
                        ...
                        <div class="col-md-3" style=" margin-top: 5px;">
                            <div class="form-group">
                                {!! Form::label('tax_total', __('fleet.total') . ' ' . __('fleet.amount'), [
                                    'class' => 'col-xs-5 control-label',
                                ]) !!}
                                <div class="col-xs-6">
                                    <div class="input-group">
                                        ...
                                        <input required="required" name="tax_total" type="text" id="tax_total"
                ...
                <div class="card-header">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-4">
                                <h3 class="card-title">
                                    @lang('fleet.todayIncome'): <strong><span id="total_today"> {{ $currency . ' ' . $total }} </span>
                                    </strong>
                                </h3>
                            </div>
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" name="ids[]" value="{{ $row->id }}"
                                            class="checkbox" id="chk{{ $row->id }}" onclick='checkcheckbox();'>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        @can('Transactions delete')
                                            <button type="button" class="btn btn-danger delete"
                                                data-id="{{ $row->id }}" title="@lang('fleet.delete')"><span
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#income_type').select2({
                placeholder: "@lang('fleet.incomeType')"
            });
