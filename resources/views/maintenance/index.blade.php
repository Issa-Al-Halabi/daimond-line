                    ...
                    <select id="vehicle_id" name="vehicle_id" class="form-control vehicles" style="width: 100%"
                        ...
                        {{-- <div class="col-md-3" style="margin-top: 10px;">
                            <div class="input-group">
                                ...
                                <input name="date" type="date" id="date" value="{{ date('Y-m-d') }}"
                                    class="form-control">
                            </div>
                            </div> --}}
                        {{-- <div class="col-md-4"style="margin-top: 5px;">
                            <div class="input-group ">
                                <label class="switch">
                                    <input type="checkbox" class="input-group-prepend" name="status">
        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header" style="color:#fbfbfb;">
                    <div class="row">
                        <div class="col-md-4">
                            <h3 class="card-title"> @lang('fleet.manage_maintenance') :
                            </h3>
                        </div>
                    ...
                    <table class="table" id="data_table">
                        <thead class="thead-inverse">
                            <tr>
                                ...
                                <th>@lang('fleet.maintnance_type')</th>
                        ...
                        <tbody>
                            @foreach ($data1 as $row)
                                @foreach ($row as $ex)
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="ids[]" value="{{ $ex->id }}"
                                                class="checkbox" id="chk{{ $ex->id }}" onclick='checkcheckbox();'>
                                        </td>
                                        <td>{{ $i++ }}</td>
                                        <td>{{ $ex->car_model }}</td>
                                        <td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => 'admin/maincate_delete', 'method' => 'POST', 'id' => 'form_delete']) !!}
