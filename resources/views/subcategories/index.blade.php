        ...
        <div class="col-md-12">
            ...
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title" style="color:#fbfbfb;">@lang('fleet.governorate')
                        &nbsp; @can('Customer add')
                            <a href="{{ route('subcategories.create') }}" class="btn btn-success" title="@lang('fleet.add_new_cat')"><i
                                    class="fa fa-plus"></i></a>
                        @endcan
                        {{-- @can('Customer import') --}}
                        {{-- &nbsp;&nbsp;<button data-toggle="modal" data-target="#import"
                            class="btn btn-warning">@lang('fleet.import')</button> --}}
                        {{-- @endcan --}}
                    </h3>
                </div>
    ...
    <div id="bulkModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => 'admin/delete-goverments', 'method' => 'POST', 'id' => 'form_delete']) !!}
