		...
		<div class="card card-success">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="row">
						<div class="form-group">
							<input type="submit"  class="form-control btn btn-success"  value="@lang('fleet.change_details')" />
						</div>
					</div>
				{!! Form::close()!!}
	...
	<div class="col-md-12">
        ...
        >
				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							<input type="submit"  class="form-control btn btn-success"  value="@lang('fleet.change_password')" />
						</div>
						{!! Form::close()!!}
					</div>
				</div>
