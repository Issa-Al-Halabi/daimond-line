...
@section('breadcrumb')
    ...
    {{-- <li class="breadcrumb-item active">@lang('fleet.editfa')</li> --}}
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title" style="color:#fbfbfb;">@lang('fleet.editfare')</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => ['fare.update', $fare->id], 'files' => true, 'method' => 'PATCH']) !!}
