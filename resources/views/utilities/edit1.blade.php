        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">@lang('fleet.editfare')</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => ['fare.update1', $fare->id], 'files' => true, 'method' => 'PATCH']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('base_km', $fare->base_km, ['class' => 'form-control', 'required']) !!}
                            </div>
                           <div class="form-group">
                                {!! Form::label('cost', __('fleet.cost'), ['class' => 'form-label']) !!}
                                {!! Form::text('cost',$fare->cost, ['class' => 'form-control', 'required']) !!}
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('base_time', $fare->base_time, ['class' => 'form-control', 'required']) !!}
                            </div>
                           <div class="form-group">
                                {!! Form::label('limit_distance', __('fleet.Limit_distance'), ['class' => 'form-label']) !!}
                                {!! Form::text('limit_distance', $fare->limit_distance, ['class' => 'form-control', 'required']) !!}
                            </div>
