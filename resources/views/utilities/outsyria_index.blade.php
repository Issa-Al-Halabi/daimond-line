        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-4">
                            <h3 class="card-title"> @lang('fleet.fare_manage_outside') : <strong><span id="total_today"> <a
                                            href="{{ route('outside_create') }}" class="btn btn-success"
                                            ...
                                            <div class="dropdown-menu custom" role="menu">
                                                {{-- @can('Vehicles edit')
                                                    <a class="dropdown-item"
                                                        href="{{ url('admin/vehicles/' . $row->id . '/edit') }}"> <span
                                                ...
                                                <a class="dropdown-item openBtn" data-id="{{ $row->id }}"
                                                    ...
                                                    <span class="fa  fa-edit" aria-hidden="true"
                                                        style="color: #398439"></span> @lang('fleet.edit')
                                                </a>
                                            </div>
                                            {{-- <div class="dropdown-menu custom" role="menu">
                                                <a class="dropdown-item" href="{{ url('admin/getfare/' . $row->id) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">@lang('fleet.Edit_price')</h4>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.openBtn', function() {
            ...
            $('#myModal2 .modal-body').load('{{ url('admin/outsyria-edit') }}/' + id, function(result) {
                $('#myModal2').modal({
                    show: true
                });
            });
