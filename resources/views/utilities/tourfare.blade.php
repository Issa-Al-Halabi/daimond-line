        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">@lang('fleet.add_fare'):
                    </h3>
                </div>
               <?php
                        ...
                        <div class="col-md" style="margin-top: 10px;">
                            ...
                            <div class="input-group">
                                <input name="price" type="text" id="name" class="form-control"
                                    placeholder=" @lang('fleet.price')" style="width: 250px">
                            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md" style="margin-top: 10px;">
                            ...
                            <div class="input-group">
                                <input name="price" type="text" id="name" class="form-control" value="{{$fare->price }}"
                                    placeholder=" @lang('fleet.price')" style="width: 250px">
                            </div>
                        ...
                        <div class="col-md-1" style="margin-top: 10px;">
                            @can('Transactions add')
                                <button type="submit" class="btn btn-success">@lang('fleet.edit')</button>
                            @endcan
                        </div>
