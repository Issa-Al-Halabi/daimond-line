...
{{--  --}}
                ...
                {{-- <tr>
                    <td>@lang('fleet.base_km')</td>
                    <td>@lang('fleet.time_per_minute')</td>
                    <td>@lang('fleet.weekend_base_km')</td>
                    <td>@lang('fleet.weekend_time_per_minute')</td>
                    <td>@lang('fleet.night_base_km')</td>
                    <td>@lang('fleet.night_per_minut')</td>
                <tr> --}}
