        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title"style="color:#fbfbfb;">@lang('fleet.edit_vehicle_type')</h3>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            @if ($vehicle_type->icon != null)
                                <a href="{{ asset('/uploads/' . $vehicle_type->icon) }}"
                                    target="blank">@lang('fleet.view')</a>
                            @endif
                            <br>
                                ...
                                <div class="col-md-3">
                                    <label class="switch">
                                        <input type="checkbox" name="isenable" value="1"
                                            @if ($vehicle_type->isenable == 1) checked @endif>
