<div role="tabpanel">
    <ul class="nav nav-pills">
        <li class="nav-item"><a href="#info-tab" data-toggle="tab" class="nav-link custom_padding active"> @lang('fleet.general_info')
                <i class="fa"></i></a>
        </li>

        <li class="nav-item"><a href="#address-tab" data-toggle="tab" class="nav-link custom_padding"> @lang('fleet.insurance') <i
                    class="fa"></i></a>
        </li>

        <li class="nav-item"><a href="#acq-tab" data-toggle="tab" class="nav-link custom_padding"> @lang('fleet.purchase_info') <i
                    class="fa"></i></a>
        </li>

        <li class="nav-item"><a href="#reviews" data-toggle="tab" class="nav-link custom_padding"> @lang('fleet.vehicle_inspection') <i
                    class="fa"></i></a>
        </li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="info-tab">
            <table class="table table-striped">
                ...
                <tr>
                    <th>@lang('fleet.intMileage') @if (Hyvikk::get('dis_format') == 'km')
                            (@lang('fleet.km'))
                            @endif @if (Hyvikk::get('dis_format') == 'miles')
                                (@lang('fleet.miles'))
                            @endif
                    </th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        @php
                            $drivers = $vehicle->getMeta('driver_id')
                                ? $vehicle
                                        ->drivers()
                                        ->pluck('name')
                                        ->toArray() ?? []
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @foreach ($vehicle->reviews as $r)
                                <a href="{{ url('admin/view-vehicle-review/' . $r->id) }}" class="btn btn-success"
                                    style="margin-bottom: 5px;" title="View Review">@lang('fleet.reg_no'):
                                    {{ $r->reg_no }}</a>
                                &nbsp; <a href="{{ url('admin/print-vehicle-review/' . $r->id) }}"
                                    class="btn btn-danger" target="_blank" title="@lang('fleet.print')"
                                    style="margin-bottom: 5px;"><i class="fa fa-print"></i> @lang('fleet.print')</a>
                                <br>
                            @endforeach
                        </div>
