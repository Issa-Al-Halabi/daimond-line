...
Route::namespace('Admin')->group(function () {
        ...
        Route::group(['middleware' => ['log','lang_check', 'auth', 'officeadmin', 'IsInstalled']], function () {
                ...
                Route::get('points/{id}/update', 'PointController@update')->name('points.edit');
                Route::delete('points/{id}/delete', 'PointController@destroy')->name('points.delete');
                Route::post('/points-fetch', 'PointController@fetch_data');
                //end points

                //user points
                Route::get('userpoints', 'UserpointController@index')->name('userpoints');
                Route::delete('/user_points-fetch', 'UserpointController@fetch_data');
               ...
               //complaint section
                ...
                Route::delete('complaints/delete/{id}', 'ComplaintController@destroy');
                Route::post('complaints/bluck_delete', 'ComplaintController@bulk_delete');
                ...
                Route::get('coupons/{id}/update', 'CouponController@update')->name('coupons.edit');
                Route::delete('coupons/{id}/delete', 'CouponController@destroy')->name('coupons.delete');
                Route::post('/coupons-fetch', 'CouponController@fetch_data');
                //end coupons
                ...
                Route::post('/categories-fetch', 'CategoryController@fetch_data');
                // subcategory
              
                Route::resource('subcategories', 'SubCategoryController');
               
                
                Route::post('/subcategories-fetch', 'SubCategoryController@fetch_data');
           Route::post('delete-goverments', 'SubCategoryController@bulk_delete');

                Route::get("dropdown", "VehiclesController@upload_info");
                Route::get("dropdown1", "VehiclesController@upload_info1");
                ...
                Route::resource('/users', 'UsersController')->middleware('log');
                ...
                Route::get('/Transfer-approval', 'WalletController@Transfer_approval');
                ...
                Route::get('getfare/{id}', 'SettingsController@fare_edit');
                Route::get('getfare1/{id}', 'SettingsController@fare_edit1');
                Route::patch('getfareupdate/{id}', 'SettingsController@update')->name('fare.update');
                Route::patch('getfareupdate1/{id}', 'SettingsController@update1')->name('fare.update1');
                Route::delete('delete-fare/{id}', 'SettingsController@delete')->name('delete-fare');
                Route::delete('delete-fare1/{id}', 'SettingsController@delete1')->name('delete-fare1');
                Route::get('faretour_create', 'SettingsController@create_tourfare')->name('create_tourfare');
                Route::post('faretour_store', 'SettingsController@store_tourfare')->name('store_tourfare');
                Route::get('faretour_edit/{id}', 'SettingsController@edit_tourfare')->name('edit_tourfare');
                Route::patch('faretour_update/{id}', 'SettingsController@update_tourfare')->name('update_tourfare');
                Route::delete('faretour_delete/{id}', 'SettingsController@delete_tourfare')->name('delete_tourfare');
                ...
                // reviews
                Route::get('reviews', 'ReviewRatings@index')->name('admin.reviews');
              Route::delete('review/delete/{id}', 'ReviewRatings@delete');
                ...
                Route::post('/fare_bulkdelete', 'SettingsController@bulk_delete');
                Route::post('/fare_bulkdelete1', 'SettingsController@bulk_delete1');
                // fare
                Route::get('fare1', 'SettingsController@fare_index1');
                Route::get('fare', 'SettingsController@fare_index');
                Route::post('fare-settings', 'SettingsController@store_fareSettings');
                Route::post('fare-store', 'SettingsController@fare_store')->name('farestore');
                Route::get('fare-create', 'SettingsController@fare_create')->name('farecreate');
                Route::get('outsyria-create', 'SettingsController@outsidesyria_create')->name('outside_create');
                Route::get('outsyria-index', 'SettingsController@outsidesyria_index');
                Route::get('outsyria-edit/{id}', 'SettingsController@outsidesyria_edit');
                Route::post('store-outsidesyria', 'SettingsController@store_outsidesyria')->name('store_outside');
                Route::patch('update_price/{id}', 'SettingsController@update_price')->name('update_price');
                //caroption

                Route::get('/car_option', 'CarOptionController@index')->name('car_option.index');
                Route::post('/car_option', 'CarOptionController@store')->name('car_option.store');
                Route::get('/car_option/{id}', 'CarOptionController@edit')->name('car_option.edit');
                Route::patch('/car_option/{id}', 'CarOptionController@update')->name('car_option.update');
                Route::delete('/car_option/{id}', 'CarOptionController@destroy')->name('car_option.delete');
                Route::post('/delete-option', 'CarOptionController@bulk_delete')->name('car_option.delete');
                //contact
           ...
           Route::post('/delete-contact', 'ContactController@bulk_delete');
                // wallet
                ...
                Route::delete('/wallet/delete/{id}', 'WalletController@destroy')->name('wallet.destroy');
          Route::post('/delete-wallet', 'WalletController@bulk_delete');
                ...
                Route::get('/bookings/assign/{id}', 'BookingsController@assign_driver')->name('assign.driver');
           Route::get('/edit-expense/{id}', 'BookingsController@edit_expense');
                // in city instant
                Route::get('/booking/index', 'BookingsController@index_incity')->name('incity.index');
                Route::post('/booking/incity-fetch', 'BookingsController@fetch_data_incity');
                // in city delayed
                Route::get('/booking_delay/index', 'BookingsController@index_delay_incity')->name('incity_delay.index');
                Route::post('/booking_delay/incity-fetch', 'BookingsController@fetch_delay_incity');
                ///
                ...
                Route::get('/changeStatus', 'ExpenseController@changeStatus');
                //maintenance
                Route::resource('/maintenance', 'MaintenanceController');
                Route::post('/maincate_delete', 'MaintenanceController@bulk_delete');
                Route::resource('/maintcategory', 'MaintenanceCategoryController');

                Route::get("/bookings/expense/{id}", 'BookingsController@add_expense');
           Route::get("/bookings/edit_expense/{id}", 'BookingsController@edit_expense');
                Route::post("/bookings/expense/store", 'BookingsController@store_expense')->name('booking_expense');
           Route::post("/bookings/expense/update", 'BookingsController@update_expense')->name('update_expense');
                Route::resource('/expensecategories', 'ExpenseCategories');
                Route::post('/expensecate_delete', 'ExpenseCategories@bulk_delete');
                Route::post('/maitecate_delete', 'MaintenanceCategoryController@bulk_delete');
                ...
                //--------------------------------------
                Route::match(array('GET', 'POST'), 'admin-fare/create', 'WalletController@store_admin_fare')->name('admin-fare/create');
                //--------------------------------------
                Route::match(array('GET', 'POST'), 'time_out/create', 'WalletController@store_time_out')->name('time_out/create');
          
        });

        Route::group(['middleware' => ['log','lang_check', 'auth']], function () {
