        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header with-border">
                    <h3 class="card-title"> <?php echo app('translator')->get('fleet.manage_trips'); ?>: &nbsp;
                        ...
                        <table class="table table-responsive display" id="ajax_data_table"
                            ...
                            <thead class="thead-inverse">
                                <tr>
                                    ...
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.vehicle_type'); ?></th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.vehicle_model'); ?></th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.from'); ?></th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.destination'); ?></th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.to'); ?></th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.direction'); ?></th>
                                   

                                    
                                   
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.date'); ?></th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.status'); ?></th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.Tour'); ?>?</th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.cost'); ?></th>
                            ...
                            <tfoot>
                                <tr>
                                    <th>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Bookings delete')): ?>
                                    ...
                                    <th><?php echo app('translator')->get('fleet.vehicle_model'); ?></th>
                                    <th><?php echo app('translator')->get('fleet.from'); ?></th>
                                    <th><?php echo app('translator')->get('fleet.destination'); ?></th>
                                    <th><?php echo app('translator')->get('fleet.to'); ?></th>
                                 <th><?php echo app('translator')->get('fleet.direction'); ?></th>
                                
                                    <th><?php echo app('translator')->get('fleet.date'); ?></th>
                                    <th><?php echo app('translator')->get('fleet.status'); ?></th>
                                    <th><?php echo app('translator')->get('fleet.Tour'); ?>?</th>
                    ...
                    <div class="fleet card-body">
                        ...
                        <?php if(Hyvikk::get('tax_charge') != 'null'): ?>
                            ...
                            <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <input type="hidden" name="<?php echo e('tax_' . $i); ?>" value="<?php echo e($val); ?>"
                                    class="<?php echo e('tax_' . $i); ?>">
                                <?php ($i++); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <?php echo Form::number('total_tax_charge', 0, [
                                            'class' => 'form-control
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  sum',
                                            'readonly',
                                            'id' => 'total_tax_charge',
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <?php echo Form::number('total_tax_charge_rs', 0, [
                                            'class' => 'form-control
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  sum',
                                            'readonly',
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <?php echo Form::number('tax_total', null, [
                                            'class' => 'form-control',
                                            'id' => 'tax_total',
                                            'readonly',
                                            'min' => 0,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\EM_Projects\xampp\htdocs\Laravel\diamond_backend\resources\views/bookings/index.blade.php ENDPATH**/ ?>