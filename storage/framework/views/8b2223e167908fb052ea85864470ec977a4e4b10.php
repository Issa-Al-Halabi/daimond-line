		...
		<div class="card card-success">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="row">
						<div class="form-group">
							<input type="submit"  class="form-control btn btn-success"  value="<?php echo app('translator')->get('fleet.change_details'); ?>" />
						</div>
					</div>
				<?php echo Form::close(); ?>
...
<div class="row">
	<div class="col-md-12">
		<div class="card card-success">
            ...
            pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
            title="Password must be at least 8 characters long and contain at least one lowercase letter, one uppercase letter, and one digit."
        >
				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							<input type="submit"  class="form-control btn btn-success"  value="<?php echo app('translator')->get('fleet.change_password'); ?>" />
						</div>
						<?php echo Form::close(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\EM_Projects\xampp\htdocs\Laravel\diamond_backend\resources\views/utilities/changepass.blade.php ENDPATH**/ ?>