...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.add_vehicle_type'); ?></li>
<?php $__env->stopSection(); ?>
        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title"><?php echo app('translator')->get('fleet.add_vehicle_type'); ?></h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <!--</div>-->
                        <!--<div class="form-group col-md-6">-->
                        <!--    <?php echo Form::label('bags', __('fleet.bags'), ['class' => 'form-label']); ?>-->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\EM_Projects\xampp\htdocs\Laravel\diamond_backend\resources\views/vehicle_types/create.blade.php ENDPATH**/ ?>