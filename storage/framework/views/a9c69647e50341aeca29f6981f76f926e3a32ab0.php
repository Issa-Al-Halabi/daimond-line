...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <?php endif; ?>
      <p class="login-box-msg"><?php echo app('translator')->get('passwords.reset_password'); ?></p>
      <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('password.email')); ?>">
        ...
        <div class="row">
          <div class="col-12">
            <button type="submit" class="btn btn-primary btn-block btn-flat"><?php echo app('translator')->get('passwords.send_reset_link'); ?></button>
          </div>
          <!-- /.col -->
        </div>
      </form>
...
</html><?php /**PATH /home/diamond/public_html/framework/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>