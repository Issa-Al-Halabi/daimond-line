        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title"><?php echo app('translator')->get('fleet.editfare'); ?></h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <?php echo Form::open(['route' => ['fare.update1', $fare->id], 'files' => true, 'method' => 'PATCH']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                                ...
                                <?php echo Form::text('cost',$fare->cost, ['class' => 'form-control', 'required']); ?>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                                ...
                                <?php echo Form::text('limit_distance', $fare->limit_distance, ['class' => 'form-control', 'required']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/diamond/public_html/framework/resources/views/utilities/edit1.blade.php ENDPATH**/ ?>