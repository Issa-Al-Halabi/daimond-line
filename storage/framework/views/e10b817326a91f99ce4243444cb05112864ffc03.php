        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title" style="color:#fbfbfb;"><?php echo app('translator')->get('fleet.manageUsers'); ?>
                        &nbsp;
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Users add')): ?>
                            <a href="<?php echo e(route('users.create')); ?>" class="btn btn-success" title="<?php echo app('translator')->get('fleet.addUser'); ?>"><i
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\EM_Projects\xampp\htdocs\Laravel\diamond_backend\resources\views/users/index.blade.php ENDPATH**/ ?>