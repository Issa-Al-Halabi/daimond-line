            ...
            <div class="box box-info">
               ...
               <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title"><?php echo app('translator')->get('fleet.time_out_trip'); ?>:
                    </h3>
                </div>
          
               <div class="card-body">

					<?php echo Form::open(['url' => 'admin/time_out/create', 'class' => 'form-horizontal']); ?>
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<div class="input-group">
									<?php echo Form::number('time_out',$val->value, ['class' => 'form-control', 'placeholder' => 'Enter Minutes' ,'min'=>"1",'max'=>"60"]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/diamond/public_html/framework/resources/views/wallet/time_out.blade.php ENDPATH**/ ?>