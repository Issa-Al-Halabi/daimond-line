        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title"><?php echo app('translator')->get('fleet.points'); ?> &nbsp;
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Users add')): ?>
                            <a href="<?php echo e(route('points.create')); ?>" class="btn btn-success" title="<?php echo app('translator')->get('fleet.addPoint'); ?>"><i
                    ...
                    <table class="table" id="ajax_data_table">
                        <thead class="thead-inverse">
                            <tr>
                                ...
                                <th>#</th>
                                <th><?php echo app('translator')->get('fleet.trip_type'); ?></th>
                                <th><?php echo app('translator')->get('fleet.qty'); ?></th>
                                <th><?php echo app('translator')->get('fleet.points'); ?></th>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            var table = $('#ajax_data_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(url('admin/points-fetch')); ?>",
                    type: 'POST',
                    data: {}
                },
                columns: [{
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\EM_Projects\xampp\htdocs\Laravel\diamond_backend\resources\views/points/index.blade.php ENDPATH**/ ?>