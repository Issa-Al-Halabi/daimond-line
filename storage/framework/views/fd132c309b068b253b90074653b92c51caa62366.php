            ...
            <div class="card card-success">
                <div class="card-header with-border">
                    <h3 class="card-title"> <?php echo app('translator')->get('fleet.manage_trips'); ?> &nbsp;
                        ...
                        <!--    <a href="<?php echo e(route('bookings.create')); ?>" class="btn btn-success" title="<?php echo app('translator')->get('fleet.new_booking'); ?>"><i-->
                        ...
                        <table class="table table-responsive display" id="ajax_data_table"
                            ...
                            <thead class="thead-inverse">
                                <tr>
                                    ...
                                    <!--</th>-->
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.no'); ?></th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.customer'); ?></th>
                                   <th style="width: 10% !important"><?php echo app('translator')->get('fleet.options'); ?></th>
                                    ...
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.dest_addr'); ?></th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.date'); ?></th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.time'); ?></th>
                                    <th style="width: 10% !important"><?php echo app('translator')->get('fleet.km'); ?></th>
        ...
        $(function() {
            ...
            var table = $('#ajax_data_table').DataTable({
               ...
               // }],
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(url('admin/booking_delay/incity-fetch')); ?>",
                    type: 'POST',
                    data: {}
                },
                columns: [
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\EM_Projects\xampp\htdocs\Laravel\diamond_backend\resources\views/bookings/index_in_city_delay.blade.php ENDPATH**/ ?>